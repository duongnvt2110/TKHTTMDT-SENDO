    ...
    <table class="table dataTable" id="tb-product-list" role="grid">
      <thead>
        ...
        <tr>
          ...
          <th class="text-center col-prod-code" aria-controls="tb-product-list">Tên Khách Hàng</th>
          <th class="col-prod-inf"><span>Số lần mua</span></th>
          <th class="text-center col-price"><span>Số lần hủy</span></th>
          <th class="text-center col-condition"><span>Số lần khiếu nại</span></th>
          <th class="text-center"><span>Tổng Giao dịch</span></th>
        </tr>
      </thead>
