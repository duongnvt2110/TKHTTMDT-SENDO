...
<!--           <li class="nav-item has-treeview">
  ...
  <div class="content-wrapper" >
    <form action="#" method="post" enctype="multipart/form-data" class="form-product">
      <div class='idSP'>
        <label class="col-lg-2 col-md-3 col-xs-2">IdSp *</label>
        <div class="form-info col-lg-10 col-md-8 col-xs-9">
          <input type="" name="idsp" placeholder="idsp">
        </div>
      </div>
      <div class='name'>
      ...
      <div class='sku'>
       ...
       <div class="form-info col-lg-10 col-md-8 col-xs-9">
        <input type="" name="sku" placeholder="SKU">
      </div>
    </div>
    <div class='prices'>
     <label class="col-lg-2 col-md-3 col-xs-2">Giá *</label>
     <div class="form-info col-lg-10 col-md-8 col-xs-9">
      <input type="" name="prices" placeholder="VND">
    </div>
  </div>
  <div class='volume'>
   <label class="col-lg-2 col-md-3 col-xs-2">Khối Lượng *</label>
   <div class="form-info col-lg-10 col-md-8 col-xs-9">
    <input type="" name="volume" placeholder="g">
  </div>
</div>
<div class='Amount '>
