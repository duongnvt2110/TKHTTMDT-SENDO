  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="#" class="nav-link">Confirm</a>
        </li>
         <li class="nav-item d-none d-sm-inline-block">
          <a href="#" class="nav-link">Cancel</a>
        </li>
         <li class="nav-item d-none d-sm-inline-block">
          <a href="#" class="nav-link">Xem Đơn Hàng Mới</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <a href="#" class="nav-link">Xem Đơn Hàng Bị Hủy</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <a href="#" class="nav-link">Xem Đơn Hàng Thành Công</a>
        </li>
      </ul>
   ...
   <table class="table dataTable" id="tb-product-list" role="grid">
    <thead>
      ...
      <tr>
        ...
        <th class="text-center col-prod-code" aria-controls="tb-product-list">Mã Đơn Hàng</th>
        <th class="col-prod-inf"><span>Tên SP</span></th>
        <th class="col-prod-inf"><span>Mã Sản Phẩm</span></th>
