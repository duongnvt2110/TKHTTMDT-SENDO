...
$s=$info_product->showInfomationProduct();
...
<head>
  ...
  <link rel="stylesheet" href="php/sendo.css">
</head>
    ...
    <table class="table dataTable" id="tb-product-list" role="grid">
      ...
      <tbody >
        ...
        <?php foreach ($s as $value) { ?>
          <?php for($i=0;$i<$value['totalItems'];$i++) {?>
          <tr>
            <td class="col-ck">
              <div class="checkbox-nice">
                <input type="checkbox" id="checkbox-all" data-bind="checked: SelectedAll">
            ...
            <td class="col-prod-inf"><span><?php echo $value['Products'][$i]['ProductSKU']?></span></td>
            <td class="text-center col-prod-code" aria-controls="tb-product-list"><?php echo $value['Products'][$i]['ProductName']?></td>
            <td class="text-center col-price"><span><?php echo $value['Products'][$i]['ProductPrice']?></span></td>
            <td class="text-center col-status"><span><?php echo $value['Products'][$i]['ProductStatus']?></span></td>
            <th class="text-center"><span><?php echo $value['Products'][$i]['StockQuantity']?></span></th>
          </tr>
          <?php }?>
        <?php } ?>
