...
class sendo
{
	...
	public function login_sendo($user,$pass,$cookie)
	{
		$GLOBALS['http']=new curl('');
	...
	public function get_cookie()
	{
		...
		$myfile = file_get_contents("../app/Classes/cookie.txt");
		preg_match('/__RequestVerificationToken\s(.*?)\s/',$myfile,$result);
		return $result[1];
	}

	public function post_product($name,$Code_Model,$Prices,$UnitId,$Weight,$StockQuantity,$Description)
	{
		$GLOBALS['http']=new curl('');
		// Data Post Product
	...
	public function show_infomation_product()
	{
		$GLOBALS['http']=new curl('');
